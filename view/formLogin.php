                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <h2>Seja bem-vindo ao Colégio Lisboa.</h2>

                            <p>Para conectar-se à intranet informe o seu usuário e senha.
                            <!--Utilize o mesmo usuário e senha do SL (Sistema Integrador).-->
                            </p>
                        </div>
                        <div class="col-md-6">
                            <form class="form-signin" action="login.php" method="POST">
                                    <?php
                              if (filter_input(INPUT_GET, "menssagem")=="erro"){
                                ?>
                                <div class="alert alert-warning">
                                  <strong>Atenção!</strong> Usuário e senha não Conferem.
                                </div>
                                <?php
                              }elseif(filter_input(INPUT_GET, "menssagem")=="deslogado"){
                                ?>
